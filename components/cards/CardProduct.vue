...
<template>
  <section class="bg-white shadow-xl rounded-xl overflow-hidden">
    ...
    <div class="px-5 pb-5 pt-9 relative">
      ...
      <div :class="`cursor-pointer absolute -top-5 right-7 w-[50px] h-[50px] ${oneProduct.isCart ? 'bg-blue-600 text-white' : 'bg-white'} shadow-xl rounded-full flex justify-center items-center hover:bg-blue-600 hover:text- white transition duration-300`" @click="addCart">
